...
// import yearlyResultsList from './AllResultsList/AllResultsList'
...
class YearlyResultsPage extends Component {
    componentDidMount = () => {
...
export default connect(mapStateToProps)(YearlyResultsPage);
